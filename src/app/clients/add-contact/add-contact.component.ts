...
@Component({
  ...
  styles: [`
    ...
    .field-label { display: block; font-size: 0.75rem; font-weight: 500; margin-bottom: 0.375rem; }
    ...
    .field-hint { font-size: 10px; color: #62748e; margin-top: 0.25rem; }
    .btn-outline { display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem; padding: 0.75rem 1rem; font-size: 14px; font-weight: 600; color: #475569; background-color: #fff; border: 1px solid #e2e8f0; border-radius: 0.5rem; cursor: pointer; transition: background-color 0.15s, color 0.15s; }
    .btn-outline:hover { background-color: #f8fafc; color: #1e293b; }
    .btn-primary { display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem; padding: 0.5rem 1rem; font-size: 14px; font-weight: 600; color: #fff; background-color: #2563eb; border: 1px solid transparent; border-radius: 8px; cursor: pointer; transition: background-color 0.15s; }
