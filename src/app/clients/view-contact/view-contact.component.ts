...
@Component({
  ...
  styles: [`
    ...
    .badge { display: inline-flex; align-items: center; padding: 0.125rem 0.625rem; border-radius: 12px; font-size: 11px; font-weight: 600; }
    .info-label { font-size: 12px; font-weight: 500; color: #94A3B8; margin-bottom: 0.25rem; }
    .info-value { font-size: 12px; font-weight: 400; color: #0F172A; display: flex; align-items: center; gap: 0.5rem; }
